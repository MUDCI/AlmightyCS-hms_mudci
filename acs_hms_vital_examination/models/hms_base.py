...
class Appointment(models.Model):
    ...
    vs_lot_of_ear_wax = fields.Boolean(string="Quantité importante de cérumen", help='People who produce a lot of earwax are more likely to have an earwax blockage and impaction, which is where the wax gets pushed deep inside the ear canal.')
    ...
    vs_post_nasal_drip = fields.Boolean(string="Ecoulement post-nasal", help='Secretions from the nose that drain down into the throat, causing congestion and cough. Postnasal drip is usually caused by allergies or the common cold.')
    ...
    vs_eye_redness = fields.Boolean(string="Rougeur des yeux", help='Eye redness from irritated or inflamed blood vessels on the surface of the white part of the eye, commonly called bloodshot eyes.')
    ...
    vs_conjunctivitis = fields.Boolean(string="Conjonctivite", help='Inflammation or infection of the outer membrane of the eyeball and the inner eyelid.')
    ...
    vs_red_eye_lid = fields.Boolean(string="Paupière rouge", help='Allergies, infections, and even crying can cause your eyelids to redden.')
    vs_swollen_eye_lid = fields.Boolean(string="Paupière enflée", help='Eyelid swelling is the enlargement of either or both the lower and upper eyelids, on one or both eyes.')
    ...
    vs_eye_lid_pimple = fields.Boolean(string="Bouton sur la paupière", help='Most bumps on the eyelid are styes.')
