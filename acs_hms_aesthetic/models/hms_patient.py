...
class ACSPatient(models.Model):
    ...
    ach_any_treatement = fields.Selection([('no','NON'), ('yes','YES')
    ...
    ach_dermatological_treatement = fields.Selection([('no','NON'), ('yes','YES')
    ...
    ach_any_surgery = fields.Selection([('no','NON'), ('yes','YES')
    ...
    ach_skin_problem = fields.Selection([('no','NON'), ('yes','YES')
    ...
    ach_undergone_chemical = fields.Selection([('no','NON'), ('yes','YES')
    ...
    ach_undergone_chemical_in_month = fields.Selection([('no','NON'), ('yes','YES')
    ], default="no",string="In the last month?")

    # ach_undergone_retina = fields.Selection([('no','NO'), ('yes','YES')
    ach_undergone_retina = fields.Selection([('no','NON'), ('yes','YES')
    ...
    ach_undergone_retina_in_3month = fields.Selection([('no','NON'), ('yes','YES')
    ], default="no",string="In the last 3 month?")

    # ach_use_acne = fields.Selection([('no','NO'), ('yes','YES')
    ach_use_acne = fields.Selection([('no','NON'), ('yes','YES')
    ...
    ach_use_acne_in_6_month = fields.Selection([('no','NON'), ('yes','YES')
    ...
    ach_skin_itching = fields.Selection([('no','NON'), ('yes','YES')
    ...
    ach_claustrophobia = fields.Selection([('no','NON'), ('yes','YES')
    ...
    routine_clear = fields.Boolean(string="Propreté")
    # routine_clear_comment = fields.Char(string="Clear Remark")
    routine_clear_comment = fields.Char(string="Note sur la propreté")
